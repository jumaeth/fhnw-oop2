...
public class PlacesSearch extends Application {
    ...
    public static void main(String[] args) {
        new PlacesSearch().start("Wikidata Places Search", WIDTH, HEIGHT);
    }
    ...
    private void search(String text) {
        ...
        new Thread(() -> {
            ...
            result.ifPresent(item -> {
                ...
                // update controls in UI thread (new method in guilib):
                runOnUIThread(() -> {
                    // check if search field still contains the same text,
                    // otherwise discard "old" results
