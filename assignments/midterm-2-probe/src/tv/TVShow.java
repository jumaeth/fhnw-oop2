...
public class TVShow {
    ...
    // TODO: Beobachter-Funktionalität implementieren
    // Die Klasse TVShow soll z. B. so verwendet werden können:
    //
    //     var show = new TVShow("Sherlock");
    //     show.addWatcher(season -> System.out.println(season + ": " + season.episodes()));
    //     show.addSeason(3, new Date(2010, 7, 25));
    //
    // In diesem Beispiel würde "Sherlock S1: 3" auf der Konsole ausgegeben werden.
}
